...
export class AboutHarman extends Component {
        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="about harman" src="./themes/Yaru/status/about.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">About Me</span>
                </div>
                <div id="education" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "education" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="harman' education" src="./themes/Yaru/status/education.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Education</span>
                </div>
                <div id="skills" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "skills" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="harman' skills" src="./themes/Yaru/status/skills.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Skills</span>
                </div>
                <div id="projects" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "projects" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="harman' projects" src="./themes/Yaru/status/projects.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Projects</span>
                </div>
                <div id="resume" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "resume" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="harman's resume" src="./themes/Yaru/status/download.svg" />
...
export const displayAboutHarman = () => {
    return <AboutHarman />;
}
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/main_photo.jpg" alt="Harman Preet Singh Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>My name is <span className="font-bold">Harman Preet Singh</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Software Engineering Manager | Front End Lead Developer!</span></div>
            </div>
            ...
            <ul className=" leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                ...
                <li className=" mt-3 list-star">Got CEO appreciation (Jan 2011) within six months of my tenure for Outstanding Performance in Alcatel Lucent.</li>
                <li className=" mt-3 list-star">First position in B. Tech (All Semesters).</li>
            </ul>
        </>
    )
}
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    ...
                    <div className=" text-sm text-gray-400 mt-0.5">2006 - 2010</div>
                    <div className=" text-sm md:text-base">Computer Science & Engineering</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">84.03% percentage (GPA 4.0)</div>
                </li>
            </ul>
        </>
    )
    ...
    return (
        <>
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <a href="https://www.google.com/search?q=is+html+a+language%3F" target="_blank" rel="noreferrer"><img title="yes it's a language!" className="m-1" src="https://img.shields.io/badge/-HTML5-%23E44D27?style=flat&logo=html5&logoColor=ffffff" alt="harman HTML" /></a>
                        <img src="https://img.shields.io/badge/-TypeScript-%23FFFFFF?style=flat&logo=TypeScript&logoColor=%23007acc" alt="TypeScript" className="m-1" />
                        <img src="https://img.shields.io/badge/-Storybook-%23FFFFFF?style=flat&logo=Storybook&logoColor=%23FF4785" alt="Storybook" className="m-1" />
                        <img src="https://img.shields.io/badge/-Git-%23F05032?style=flat&logo=git&logoColor=%23ffffff" alt="Git" className="m-1" />
                    </div>
                </div>
                <div className="px-2 flex flex-wrap items-start w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        <img className=" m-1" src="https://img.shields.io/badge/Next-black?style=flat&logo=next.js&logoColor=ffffff" alt="NextJS" />
                        <img className=" m-1" src="https://img.shields.io/badge/-React-61DAFB?style=flat&logo=react&logoColor=ffffff" alt="ReactJS" />
                        <img className=" m-1" src="https://img.shields.io/badge/-Jest-%23CC5430?style=flat&logo=jest&logoColor=%23FFFFFF" alt="Jest" />
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list mt-4">
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <span>Other Knowledge</span> 
                </li>
            </ul>
            <div className="w-full md:w-10/12 flex mt-4">
                <div className=" text-sm text-center md:text-base w-1/5">Material UI</div>
                <div className=" text-sm text-center md:text-base w-1/5">Figma</div>
                <div className=" text-sm text-center md:text-base w-1/5">REST API</div>
                <div className=" text-sm text-center md:text-base w-1/5">APIGee</div>
                <div className=" text-sm text-center md:text-base w-1/5">TDD</div>
            </div>
            <div className="w-full md:w-10/12 flex mt-4">
                <div className=" text-sm text-center md:text-base w-1/5">Agile</div>
                <div className=" text-sm text-center md:text-base w-1/5">Couchbase</div>
                <div className=" text-sm text-center md:text-base w-1/5">SQL Server</div>
                <div className=" text-sm text-center md:text-base w-1/5">React-Native</div>
                <div className=" text-sm text-center md:text-base w-1/5">JIRA</div>
            </div>
        </>
    )
}
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Harman_CV.pdf" title="Harman's CV" frameBorder="0"></iframe>
    )
}